...
import static com.example.system.SystemTestConfiguration.SYSTEM_DB_PUBLIC_CONNECTION_TEST;
import static com.example.system.SystemTestConfiguration.SYSTEM_DB_REF_PUBLIC_CONNECTION_TEST;
...
//@TestPropertySource(locations = "/application-test.yml") // この設定がなくてもActiveProfilesだけでclasspath配下のtestのプロファイルを探してくれる、おそらく、application.ymlとtestプロファイルを見ている
@Slf4j
@SpringBootTest
@ActiveProfiles("test")
