...
public interface UserController {
    ...
    @GetMapping(value = "")
    ResponseEntity<SystemAbstractResponse> getUsers(@io.swagger.v3.oas.annotations.parameters.RequestBody(description = "ユーザ検索条件", required = false)
                                                    @Validated
                                                    @RequestBody
    ...
    @GetMapping("/{id}")
    @io.swagger.v3.oas.annotations.parameters.RequestBody(content = @Content(mediaType = MediaType.APPLICATION_FORM_URLENCODED_VALUE))
    ResponseEntity<SystemAbstractResponse> getUser(@Parameter(description = "userId", required = true) @PathVariable(value = "id") Long userId)
            throws Throwable;
    ...
    ResponseEntity<SystemAbstractResponse> postUser(@RequestBody @Validated PostUsersRequest usersReq, BindingResult result)
            throws Throwable;
    ...
    @io.swagger.v3.oas.annotations.parameters.RequestBody(content = @Content(mediaType = MediaType.APPLICATION_FORM_URLENCODED_VALUE))
    @DeleteMapping("/{id}")
    ResponseEntity<SystemAbstractResponse> deleteUser(@Parameter(description = "userId", required = true) @PathVariable(value = "id") @NotNull Long userId)
            throws Throwable;
}
