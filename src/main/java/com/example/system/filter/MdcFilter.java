...
public class MdcFilter extends OncePerRequestFilter {
  ...
  protected void doFilterInternal(@NotNull HttpServletRequest request, HttpServletResponse response,
    ...
    // MDCログ設定
    MDC.put(MdcConst.X_TRACK_ID.KEY,
        request.getHeader(MdcConst.X_TRACK_ID.KEY)); // クライアント側から送信されたトラックID
    MDC.put(MdcConst.X_SESSION_ID.KEY,
        request.getHeader(MdcConst.X_SESSION_ID.KEY)); // クライアント側から送信されたセッションID
